    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-[90%] mx-auto">
      {DefaultPrompts.map((prompt, index) => {
        ...
        return (
          <div
            key={index}
            className="group bg-zinc-800/40 backdrop-blur-lg px-6 py-4 rounded-xl flex flex-col items-center text-center transition-all duration-200  hover:scale-[1.02] hover:shadow-sm hover:shadow-purple-500"
          >
